...
public class Homepage extends javax.swing.JFrame {
    ...
    public Homepage(String  n) { //initial contructor (will automatically call initialize components method)
        initComponents();
        nm=n;
        jLabel2.setText("Logged in as "+nm);
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 60, 560, 130));
        ...
        getContentPane().add(btnNewOrder, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 410, 100, 25));
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 220, 560, 183));
        ...
        getContentPane().add(btnRemoveOrder, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 410, 110, 25));
        ...
        jLabel4.setText("Individual Orders");
        ...
        getContentPane().add(btnSys, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 410, 100, 25));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 450, 110, -1));
        ...
        getContentPane().add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 450, 100, -1));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Grey-Background-GREY.jpg"))); // NOI18N
        jLabel1.setName(""); // NOI18N
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(-7, -10, 640, 500));

        btnAdmin.setBackground(new java.awt.Color(255, 255, 255));
        btnAdmin.setText("Manager Dashboard");
        btnAdmin.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAdminActionPerformed(evt);
            }
        });
        getContentPane().add(btnAdmin, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 410, 170, 25));
    ...
    private void btnNewOrderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNewOrderActionPerformed
        ...
        Order o = new Order(nm);//creates 'o', a new object based off the Order class
...
//        
    ...
    private void btnAdminActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdminActionPerformed
        ...
        AdminPassword ap = new AdminPassword(2);
        ap.setVisible(true);
        this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Homepage(nm).setVisible(true);
            }
        });
    }
