...
public class Order extends javax.swing.JFrame {
    ...
    public Order(String n){
        initComponents(); 
        nm=n;
        jLabel5.setText("Logged in as "+ nm);
        //a.dropTable1();
       //a.createTable1();
        //a.dropTable2();
        //a.createTable2();
    ...
    private void initComponents() {
        ...
        getContentPane().add(txtStarterValue, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 410, 188, -1));
        ...
        getContentPane().add(txtMainValue, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 440, 188, -1));

        txtDessertValue.setEditable(false);
        txtDessertValue.setText("-");
        getContentPane().add(txtDessertValue, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 470, 188, -1));
        ...
        getContentPane().add(txtCost, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 500, 134, -1));
        ...
        getContentPane().add(btnAdd, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 500, -1, 25));

        txtDrinkValue.setEditable(false);
        txtDrinkValue.setText("-");
        getContentPane().add(txtDrinkValue, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 500, 188, -1));

        jLabel1.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel1.setText("₹");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 500, 15, -1));
        ...
        getContentPane().add(jScrollPane4, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 60, 597, 402));
        ...
        getContentPane().add(cbxEmployees, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 410, 133, -1));
        getContentPane().add(txtRowCost, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 470, 82, -1));

        txtFinish.setBackground(new java.awt.Color(255, 255, 255));
        ...
        getContentPane().add(txtFinish, new org.netbeans.lib.awtextra.AbsoluteConstraints(1020, 550, 110, 30));
        getContentPane().add(txtTable, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 440, 133, -1));
        ...
        getContentPane().add(jScrollPane5, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 230, 250, 154));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 60, 250, 154));
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 60, 250, 154));
        ...
        getContentPane().add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 230, 250, 154));

        txtStarterPrice.setEditable(false);
        txtStarterPrice.setText("0.0");
        getContentPane().add(txtStarterPrice, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 410, 54, -1));

        txtMainPrice.setEditable(false);
        txtMainPrice.setText("0.0");
        getContentPane().add(txtMainPrice, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 440, 54, -1));

        txtDessertPrice.setEditable(false);
        txtDessertPrice.setText("0.0");
        getContentPane().add(txtDessertPrice, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 470, 54, -1));

        txtDrinkPrice.setEditable(false);
        txtDrinkPrice.setText("0.0");
        getContentPane().add(txtDrinkPrice, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 500, 54, -1));

        jLabel2.setFont(new java.awt.Font("Microsoft Sans Serif", 0, 14)); // NOI18N
        jLabel2.setText("Employee");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 410, -1, -1));
        ...
        getContentPane().add(btnDelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(900, 550, 110, 30));
        ...
        getContentPane().add(btnBack, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 550, 90, 30));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 550, 90, 30));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 550, 110, 30));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 550, 100, 30));

        jLabel4.setBackground(new java.awt.Color(0, 0, 0));
        jLabel4.setIcon(new javax.swing.ImageIcon("C:\\Users\\MAHE\\Documents\\nh\\Restaurant-Order-System-master\\Grey-Background-GREY.jpg")); // NOI18N
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(-3, -2, 1150, 630));
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        bill=""+txtStarterValue.getText()+" "+txtStarterPrice.getText()+"\n"+txtMainValue.getText()+" "+txtMainPrice.getText()+"\n"+txtDessertValue.getText()+" "+txtDessertPrice.getText()+"\n"+txtDrinkValue.getText()+" "+txtDrinkPrice.getText();
